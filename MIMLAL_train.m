function [W,V,AW,AV,Anum,trounds]=MIMLA_train(X,train_data,train_targets,W,V,costs,norm_up,step_size0,num_sub,AW,AV,Anum,trounds,lambda,opts)
average_begin=opts.average_begin;
average_size=opts.average_size;
[n,n_class]=size(train_targets);
train_targets=train_targets.*[X,ones(n,1)];
...
for i=1:n
    ...
    Wy=Wy(:,idx_max_class);
    fyn=-inf;
if(0) % two optional implementation, switch to 0 to use the matlab code
